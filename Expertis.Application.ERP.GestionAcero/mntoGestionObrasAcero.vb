...
#Region " Acciones Toolbar "
    ...
    Public Function OrdenaTodadtPOS2(ByVal dtOrdenada As DataTable)
        ...
        dtOrFinal3.Columns.Add("41")
        dtOrFinal3.Columns.Add("42")
        dtOrFinal3.Columns.Add("43")
        dtOrFinal3.Columns.Add("44")
        dtOrFinal3.Columns.Add("45")
        dtOrFinal3.Columns.Add("46")
        dtOrFinal3.Columns.Add("47")
        dtOrFinal3.Columns.Add("48")
        dtOrFinal3.Columns.Add("49")
        dtOrFinal3.Columns.Add("50")
        dtOrFinal3.Columns.Add("51")
        dtOrFinal3.Columns.Add("52")
        dtOrFinal3.Columns.Add("53")
        dtOrFinal3.Columns.Add("54")
        dtOrFinal3.Columns.Add("55")
        dtOrFinal3.Columns.Add("56")
        dtOrFinal3.Columns.Add("57")
        dtOrFinal3.Columns.Add("58")
        dtOrFinal3.Columns.Add("59")
        dtOrFinal3.Columns.Add("60")
        dtOrFinal3.Columns.Add("61")
        dtOrFinal3.Columns.Add("62")
        dtOrFinal3.Columns.Add("63")
        dtOrFinal3.Columns.Add("64")
        dtOrFinal3.Columns.Add("65")
        dtOrFinal3.Columns.Add("66")
        dtOrFinal3.Columns.Add("67")
        dtOrFinal3.Columns.Add("68")
        dtOrFinal3.Columns.Add("69")
        dtOrFinal3.Columns.Add("70")
    ...
    Public Function BorraLineasIntermedias(ByVal dtOrdenada As DataTable)
        ...
        For Each dr As DataRow In dtOrdenada.Rows
            'La primera linea se inserta siempre
            If cont = 0 Then
                dtOrFinal.ImportRow(dr)
            Else
                Try
                    If dtOrdenada.Rows(cont)("Posicion") <> dtOrdenada.Rows(cont - 1)("Posicion") Then
                        dtOrFinal.ImportRow(dr)
                    Else
                        If dtOrdenada.Rows(cont)("Posicion") = dtOrdenada.Rows(cont + 1)("Posicion") Then
